...
public final class ConstantsRestApi {
    ...
    public static final String SERVER_ROOT_URL = "https://mighty-shore-57927.herokuapp.com/";
    public static final String SERVER_TOKEN_KEY = "token-device/user-id";
    ...
    public static final String ACCESS_TOKEN = "borrado por seguridad";
    public static final String USER_NAME = "borrado por seguridad";
    public static final String USER_ID = "borrado por seguridad";
